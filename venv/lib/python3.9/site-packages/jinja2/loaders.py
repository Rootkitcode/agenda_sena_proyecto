...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'ingresar.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/ingresar.html'`` the file from the app1 package is loaded,
    by loading ``'app2/ingresar.html'`` the file from the second.
    """
